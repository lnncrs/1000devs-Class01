...
Abra os notebooks em um ambiente Jupyter (ou no vscode com a extensão Jupyter & Python instalada)

```bash
jupyter notebook
```

Explore os notebooks para entender os conceitos e executar os exemplos.
